...
<mujoco>
    ...
    <worldbody>
        ...
        <body name="object_right" pos="1.5 0.87 0.2">
            <geom name="object_right" type="box" size="0.025 0.025 0.025"
                  material="material:object" condim="4" density="567"></geom>
            <geom name="object_right_hidden" type="box"
                  size="0.024 0.024 0.024" material="material:hidden" condim="4" contype="0" conaffinity="0" mass="0"></geom>
        ...
        <body name="target_right" pos="1.5 0.87 0.2">
            <geom name="target_right" type="box" size="0.025 0.025 0.025"
                  material="material:target" condim="4" group="2" contype="0" conaffinity="0"></geom>
            <site name="target_right:center" pos="0 0 0" rgba="1 0 0 0"
                  size="0.01 0.01 0.01"></site>
        ...
        <body name="object" pos="1 0.87 0.2">
          <geom name="object" type="box" size="0.025 0.025 0.025"
                material="material:object" condim="4" density="567"></geom>
          <geom name="object_hidden" type="box"
                size="0.024 0.024 0.024" material="material:hidden" condim="4" contype="0" conaffinity="0" mass="0"></geom>
