...
class TwoHandsManipulateEnvBBeckman(hand_env.TwoHandsEnvBBeckman,
    ...
    def _sample_goal(self):
        # TODO: breakpoint here to suss out when environment changes it.
        # Select a goal for the object position.
    ...
    def _get_obs(self):
        ...
        desired_goal = self._double_goal()  # in robot_env.TwoRobotsEnvBBeckman
        residual = desired_goal - achieved_goal
        ...
        return {
            ...
            # [[[ bbeckman: this has already paid off as i changed the code. ]]]
            ...
            'left_residual': residual[:self.CUBE_SLICER],
            'rigt_residual': residual[self.CUBE_SLICER:],
...
class TwoHandsBlockEnvBBeckman(TwoHandsManipulateEnvBBeckman):
    ...
    -------------------- WITH METHOD OVERRIDES: ---------------------------
      ...
      ===============================================================
        ...
        IMPL *  get_state(self)                  # [[[ bbeckman ]]] _get_obs proxy
        OVER *  _get_obs(self)
                                   /\
                                  is-a
                                   ||
