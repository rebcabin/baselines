...
class TwoHandsManipulateEnvBBeckman(hand_env.TwoHandsEnvBBeckman,
    ...
    def __init__(
        ...
        # [[[ bbeckman: first request is for two hands, one target. ]]]
        self.target_position = target_position
        self.target_rotation = target_rotation
        self.target_position_range = target_position_range
    ...
    def _get_obs(self):
        ...
        both_robots_qpos, both_robots_qvel = robot_get_obs(self.sim)
        assert both_robots_qpos.shape == both_robots_qvel.shape == \
