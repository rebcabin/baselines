...
class TwoHandsManipulateEnvBBeckman(hand_env.TwoHandsEnvBBeckman,
    ...
    # the shapes of the cube states, one name for the seven configuration
    # variables and one name for their six velocities).
    #
    ...
    def _is_success(self, achieved_goal, desired_goal):
        ...
        achieved_left_both = achieved_left_pos * achieved_left_rot
        ...
        achieved_rigt_both = achieved_rigt_pos * achieved_rigt_rot

        result = achieved_left_both or achieved_rigt_both
        return result
