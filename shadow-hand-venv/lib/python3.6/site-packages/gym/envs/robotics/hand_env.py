...
class TwoHandsEnvBBeckman(robot_env.TwoRobotsEnvBBeckman):
    ...
    """[[[ bbeckman
    Modify to have two targets that, by default, have the same orientation,
    ...
    def _viewer_setup(self):
        ...
        look_at = self.sim.data.body_xpos[body_id] + (0.25, 0.125 + 0.0625, 0)
    ...
    # [[[ bbeckman: unnecessary explicit delegation ]]]
    #
    # def render(self, mode='human', width=500, height=500):
