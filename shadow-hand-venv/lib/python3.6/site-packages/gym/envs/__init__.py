...
for reward_type in ['sparse', 'dense']:
    ...
    # [[[ bbeckman: A copy so as not to derange the original. If you change
    # the number of steps in a trial / episode in the environment chain (see
    # 'manipulate.py' and 'test_hand*.py'), be sure to adjust it here. ]]]
    register(
        id='TwoHandsManipulateBlocks{}-v0'.format(suffix),
        entry_point='gym.envs.robotics:TwoHandsBlockEnvBBeckman',
        kwargs=_merge({'target_position': 'random',
                       'target_rotation': 'xyz',
                       'seed': 42 ** 10},
                      kwargs),
        max_episode_steps=251000000000,
    )
